(function (language) {
  ...
  var english_language_strings = {
    ...
    string__rsvp__instructions: `<span style="font-size: 1.2em; ;">Dear guest, please confirm your presence and all other attendees using the form below - including kids.<br><br>Singles: our guest list is extremely limited, therefore we would like to keep the +1 rule as simple as "does the person you're bringing know either the bride or the groom?". We appreciate your understanding.<br><br>
...
<hr/>
  ...
  var german_language_strings = {
    ...
    string__rsvp__instructions: `<span style="font-size: 1.2em;">Liebe Gäste, bitte bestätigt eure Teilnahme sowie die Teilnahme eurer Begleitpersonen (auch Kinder) über das Formular. <br><br>Singles: Unsere Gästeliste ist sehr begrenzt, daher bitten wir, +1s nach der Regel zu handhaben: "Kennt die Person entweder die Braut oder den Bräutigam?". Wir danken euch für das Verständnis.<br><br>
  ...
  var portuguese_language_strings = {
    ...
    string__rsvp__instructions: `<span style="font-size: 1.2em;">Querido convidado, por favor, confirme sua presença e de todos os outros acompanhantes, incluindo bebês e crianças, usando o formulário abaixo. <br><br>Solteiros: nossa lista de convidados é extremamente limitada, por isso gostaríamos de seguir a seguinte regra: "a pessoa que você gostaria de trazer como acompanhante já conhece algum dos noivos?". Agradecemos sua compreensão.<br><br>
