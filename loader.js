...
var portuguese_language_strings = {
    ...
    string__accomodation__airbnb: `<h2>Airbnb</h2>
        <p>O condomínio Frade tem vários apartamentos disponíveis no Airbnb, com preços de EUR 100 a EUR 500 por noite (veja <a href="https://drive.google.com/file/d/1IJlBlgg53iFsxtFH0ABf98ETRHU21gO-/view">aqui</a>). O condomínio tem segurança própria, campo de golfe, restaurantes, shopping, praia e porto.</p>
    ...
    string__agenda__headline: 'Agenda',
    string__agenda__preliminary: 'Detalhes preliminares da agenda serão divulgados em breve',
    string__agenda__wholeagenda: `<div class="day">
...
<li>Chique praiano</li>
	...
	<li><a href="./dress_code.html">Código de Vestimenta</a></li>
